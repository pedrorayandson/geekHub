    ...
    <div class="wrapper fadeInDown">
        <div id="formContent">
            ...
            <form method="POST" action="{{ route('registerUser') }}">
                ...
                <br>
                <div class="form-group">
                    <label class="label-left">Tipo de Usuário:</label>
                </div>
                <select class="selectUser" name="tipo_user" id="tipo_user" required>
                    <option class="optionUser" value="2">Crítico</option>
                    <option class="optionUser" value="3">Admin</option>
                </select>
                <br>
                <br>
                <input type="submit" class="fadeIn fourth" value="Cadrastar">
            </form>
